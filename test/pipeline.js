  ...
  describe('Branch-based steps', function() {
    describe('copySplit', function () {
      it("should chain .copySplit()", function() {
        var query = client.gremlin(g.v(1).out('knows').copySplit(_().out('created').property('name'), _().property('age')).fairMerge());
    ...
    describe('exhaustMerge', function () {
      it('should chain .exhaustMerge()', function () {
        var query = client.gremlin(g.v(1).out('knows').copySplit(_().out('created').key('name'), _().key('age')).exhaustMerge());
